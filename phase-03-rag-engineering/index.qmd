...
1. [RAG architecture](01-rag-architecture.qmd) — the whole pipeline end to end.
2. [Document ingestion and parsing](02-document-ingestion-and-parsing.qmd) — getting clean text out of PDFs, DOCX, and HTML.
3. [Chunking strategies](03-chunking-strategies.qmd) — fixed, recursive, semantic, and parent-child.
4. [Metadata extraction and filtering](04-metadata-extraction-and-filtering.qmd) — attaching and using structure.
5. [Embedding models and dimensions](05-embedding-models-and-dimensions.qmd) — choosing what turns text into vectors.
6. [Similarity metrics](06-similarity-metrics.qmd) — cosine, dot product, and when they differ.
7. [Vector databases and ANN indexes](07-vector-databases-and-ann-indexes.qmd) — HNSW and approximate search.
8. [PostgreSQL pgvector](08-postgresql-pgvector.qmd) — vector search in a database you already run.
9. [Dense and sparse retrieval](09-dense-and-sparse-retrieval.qmd) — embeddings versus BM25 and full-text search.
10. [Hybrid search](10-hybrid-search.qmd) — combining dense and sparse results.
11. [Query transformation](11-query-transformation.qmd) — rewriting, expansion, multi-query, and HyDE.
12. [Reranking](12-reranking.qmd) — cross-encoders and the second stage.
13. [Context construction](13-context-construction.qmd) — compression and selection.
14. [Citations and grounded generation](14-citations-and-grounded-generation.qmd) — answers you can verify.
15. [Knowledge-base versioning](15-knowledge-base-versioning.qmd) — changing the corpus safely.
16. [RAG caching and latency](16-rag-caching-and-latency.qmd) — making retrieval fast and affordable.
17. [Retrieval metrics](17-retrieval-metrics.qmd) — Recall@K, Precision@K, MRR, NDCG.
18. [Generation quality metrics](18-generation-quality-metrics.qmd) — faithfulness, answer relevance, context relevance.
19. [RAG evaluation and testing](19-rag-evaluation-and-testing.qmd) — offline suites, regression, and CI gates.
20. [Multi-tenant RAG](20-multi-tenant-rag.qmd) — isolation and shared infrastructure.
21. [RAG security and access control](21-rag-security-and-access-control.qmd) — retrieval that respects permissions.
