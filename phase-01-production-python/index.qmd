...
3. [Pydantic](03-pydantic.qmd) — validation and conversion at the edge of your system.
4. [Decorators](04-decorators.qmd) — wrapping behaviour around functions.
5. [Iterators and generators](05-iterators-and-generators.qmd) — producing values lazily.
6. [Context managers](06-context-managers.qmd) — guaranteed setup and cleanup.
7. [Exception handling](07-exception-handling.qmd) — failing in a way callers can reason about.
8. [File handling](08-file-handling.qmd) — reading and writing safely.
9. [Async and asyncio](09-async-and-asyncio.qmd) — concurrency for I/O-bound work.
10. [Threads and processes](10-threads-and-processes.qmd) — concurrency for CPU-bound and blocking work.
11. [Concurrency patterns](11-concurrency-patterns.qmd) — choosing and combining models.
12. [Packaging and virtual environments](12-packaging-and-virtual-environments.qmd) — isolating and shipping code.
13. [Dependency management](13-dependency-management.qmd) — reproducible environments.
14. [Logging](14-logging.qmd) — structured, searchable records of what happened.
15. [Configuration management](15-configuration-management.qmd) — settings, secrets, and the twelve-factor idea.
16. [pytest](16-pytest.qmd) — the testing loop.
17. [Mocking](17-mocking.qmd) — replacing dependencies in tests.
18. [Profiling and performance](18-profiling-and-performance.qmd) — measuring before optimizing.
19. [FastAPI](19-fastapi.qmd) — the service layer.
20. [SQLAlchemy](20-sqlalchemy.qmd) — the ORM and the unit of work.
21. [Alembic](21-alembic.qmd) — database migrations.
22. [PostgreSQL](22-postgresql.qmd) — the durable data store.
23. [Redis](23-redis.qmd) — caching, rate limits, and ephemeral state.
24. [Authentication and authorization](24-authentication-and-authorization.qmd) — identity and permission.
25. [Background jobs](25-background-jobs.qmd) — work that outlives a request.
26. [Rate limiting](26-rate-limiting.qmd) — protecting the system from overload.
27. [API testing](27-api-testing.qmd) — testing the service boundary.
28. [Dockerizing Python applications](28-dockerizing-python-applications.qmd) — a reproducible runtime.
29. [CI/CD for Python services](29-cicd-for-python-services.qmd) — automated build, test, and deploy.
