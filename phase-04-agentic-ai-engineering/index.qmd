---
title: "Phase 4 — Agentic AI Engineering"
---
...
1. [What an AI agent is](01-what-an-ai-agent-is.qmd) — and when a plain workflow is better.
2. [The agent loop](02-the-agent-loop.qmd) — observe, reason, act.
3. [Tool execution and result validation](03-tool-execution-and-result-validation.qmd) — acting safely on the world.
4. [Agent memory: short-term and working](04-agent-memory-short-term-and-working.qmd) — what is in context right now.
5. [Agent memory: long-term, episodic, semantic](05-agent-memory-long-term-episodic-semantic.qmd) — what survives the run.
6. [Planning, decomposition, and routing](06-planning-decomposition-and-routing.qmd) — breaking a goal into steps.
7. [Reflection and self-correction](07-reflection-and-self-correction.qmd) — catching your own mistakes.
8. [Retries, termination, and loop detection](08-retries-termination-and-loop-detection.qmd) — knowing when to stop.
9. [State management and persistence](09-state-management-and-persistence.qmd) — the single source of truth.
10. [Checkpointing and durable execution](10-checkpointing-and-durable-execution.qmd) — surviving restarts.
11. [Human-in-the-loop and approvals](11-human-in-the-loop-and-approvals.qmd) — putting a person in the path.
12. [Guardrails](12-guardrails.qmd) — bounding what the agent can do.
13. [Structured agent outputs](13-structured-agent-outputs.qmd) — machine-checkable actions.
14. [Tool schemas and selection](14-tool-schemas-and-selection.qmd) — describing and choosing tools.
15. [Tool permissions](15-tool-permissions.qmd) — least privilege for agents.
16. [Parallel and conditional workflows](16-parallel-and-conditional-workflows.qmd) — direction and fan-out.
17. [Long-running and background agents](17-long-running-and-background-agents.qmd) — work beyond a request.
18. [LangGraph: graphs and state](18-langgraph-graphs-and-state.qmd) — nodes, edges, reducers.
19. [LangGraph: checkpoints, interrupts, subgraphs](19-langgraph-checkpoints-interrupts-subgraphs.qmd) — durable and human-aware.
20. [OpenAI Agents SDK](20-openai-agents-sdk.qmd) — the batteries-included alternative.
21. [Agent orchestration patterns](21-agent-orchestration-patterns.qmd) — ReAct, plan-and-execute, supervisor, worker, critic.
22. [Agent reliability](22-agent-reliability.qmd) — making agents dependable in production.
